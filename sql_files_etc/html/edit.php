...
<?php
	...
	if(isset($_POST['new-wine-name']) || isset($_POST['new-review-description']) || isset($_POST['new-score']) || isset($_POST['new-price'])){
		...
		$updateSql = "UPDATE REVIEWS SET wine_id='$newWineName', description='$newReview', score=$newScore WHERE review_id=$reviewID";
												...
												<form action='#' method='POST'>
													<div class='row gtr-25'>
														<div class='col-10 off-1'>
															<input type='text' name='new-wine-name' value='".$row['wine_id']."'/>
														</div>
														<div class='col-10 off-1'>
														...
														<div class='col-5'>
															<input type='number' step='1' min='0' max='1000' name='new-price' value='".$row['price']."'/>
														</div>
